...
const Tinder = () => {
  ...
  const getRandomUser = useCallback(async () => {
    await http.get<Student>(urls.randomPick())
  ...
  return (
    <div className={styles.tinder}>
      ...
      <div className={styles.chooseWrapper}>
        {
          student && <Button className={cn(styles.dislike, styles.btn)} onClick={dislikeStudent}><img src={dislike} alt="dislike"/></Button>
        }
        <div className={styles.center}>
          {
            student && <StudentExtendedCard student={student}/>
          }
          <Button className={styles.skip} onClick={getRandomUser}>Пропустить</Button>
        </div>
        {
          student && <Button className={cn(styles.like, styles.btn)} onClick={likeStudent}><img src={like} alt="like"/></Button>
        }
      </div>
